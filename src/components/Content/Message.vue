...
<template>
    <v-sheet class="transparent">
           ...
           <hr class="my-3">
            ...
            <div class="book_page">
                <p>The Convention on the Elimination of All Forms of Discrimination against Women (CEDAW),
            ...
            concern.</p>
        <p> Furthermore, the Philippines signed the Millennium Declaration, which includes the
            ...
            achieved.</p>
        <p> Being a signatory to CEDAW, the Philippines has made the Convention a part of the law of
            ...
            and RA 8505).</p>
        <p> For women’s rights advocates in government and nongovernment organizations as well as
        ...
        <p> The Philippines has been taking concrete steps toward integrating GAD concerns in the
            ...
            inadequate sex-disaggregated data and statistics for development planning and programming.</p>
        <p> We, the international development partners in the Philippines, are happy to collaborate with
